...
#  Magento 2.4.8-p3 Docker para desarrollo
...
el valor 'php8.4-mag2.4.8-apache_magento' es el nombre del contenedor (container_name) donde corre
Magento. Este debe ejecutarse desde la carpeta raiz del proyecto 


```
docker cp . php8.4-mag2.4.8-apache_magento:/var/www/html/app/code/Transbank/Webpay
docker exec php8.4-mag2.4.8-apache_magento /var/www/html/plugin_install.sh
```
